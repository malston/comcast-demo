...
import com.comcast.sparrow.web.xauth.XAuthTokenConfigurer;

@SpringBootApplication
@EnableWebMvcSecurity
@EnableWebSecurity(debug = false)
@Order
public class SparrowWebApplication extends WebSecurityConfigurerAdapter {
...
class CustomUserDetailsService implements UserDetailsService {
    ...
    List<UserDetails> details = Arrays.<UserDetails>asList(new SimpleUserDetails("mstine", "secret", ROLE_USER, ROLE_ADMIN), 
    		new SimpleUserDetails("littleidea", "secret", ROLE_USER, ROLE_ADMIN),
    		new SimpleUserDetails("starbuxman", "secret", ROLE_USER, ROLE_ADMIN));
